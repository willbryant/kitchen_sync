...
class SpatialFromTest < KitchenSync::EndpointTestCase
  ...
  test_each "retrieves row data with SRIDs in WKB format with a 4-byte SRID prefix" do
    execute "INSERT INTO spatialtbl VALUES (1, ST_GeomFromText('POINT(10 20)', 4326), ST_GeomFromText('POINT(20 30)', 4326)), " \
                                          "(2, ST_GeomFromText('GEOMETRYCOLLECTION(LINESTRING(1.5 2.25,3.125 4.0625),MULTIPOLYGON(((30 20, 45 40, 10 40, 30 20)),((15 5, 40 10, 10 20, 5 10, 15 5))))', 4326), NULL)"
