...
public:
	...
	string retrieve_rows_sql(const Table &table, const RowValues &prev_key, const RowValues &last_key);
	string retrieve_rows_sql(const Table &table, const RowValues &prev_key, size_t row_count);
