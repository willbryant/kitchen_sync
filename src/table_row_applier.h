...
struct TableRowApplier {
	...
	TableRowApplier(DatabaseClient &client, Unpacker<InputStream> &input, const Table &table, const ColumnValues &matched_up_to_key, const ColumnValues &last_not_matching_key): client(client) {
