...
const size_t DEFAULT_MINIMUM_BLOCK_SIZE =     256*1024; // arbitrary, latency isn't as big a problem with pipelining, but this sets the point at which we stop re-hashing and send rows
